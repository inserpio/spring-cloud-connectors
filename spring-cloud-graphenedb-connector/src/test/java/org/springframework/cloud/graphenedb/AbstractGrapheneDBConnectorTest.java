...
import org.springframework.cloud.graphenedb.GrapheneDBConnector;
 ...
 *
 */
public abstract class AbstractGrapheneDBConnectorTest {
	protected GrapheneDBConnector testCloudConnector = new GrapheneDBConnector();
